...
public class AIController : MonoBehaviour
{
    ...
    public float speedWalk = 100;                     //  Walking speed, speed in the nav mesh agent
    public float speedRun = 200;                      //  Running speed
 
    public float viewRadius = 150;                   //  Radius of the enemy view
